...
**🚀 How to use**  
  ...
  Press your hotkey to take a shot!  
...
[RU] Инструкция:  
**Запуск:** Скачайте архив из раздела Releases и запустите файл Win11.exe.  
...
**[EN] Instructions:  
Launch:** Download the executable from the Releases section and run Win11.exe.  
